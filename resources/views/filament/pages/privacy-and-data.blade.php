        ...
        <div class="p-6 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
            ...
            <div class="pt-2">
                <button
                    ...
                    class="min-h-[44px] py-2.5 px-6 rounded-xl text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 shadow-md shadow-blue-500/20 transition inline-flex items-center gap-2 cursor-pointer"
                >
                ...
                <div class="pt-2 max-w-md space-y-3">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        <input
                            ...
                            placeholder="DELETE"
                            class="flex-1 min-h-[48px] px-4 rounded-xl border border-rose-300 dark:border-rose-900 bg-white dark:bg-gray-800 text-base text-gray-900 dark:text-white"
                        />
                        <button
                            type="button"
                            wire:click="deleteAccount"
                            wire:confirm="Are you sure you want to permanently delete your account and all data?"
                            class="min-h-[48px] px-6 rounded-xl text-xs font-bold text-white bg-rose-600 hover:bg-rose-500 shadow-md shadow-rose-500/20 transition whitespace-nowrap inline-flex items-center justify-center cursor-pointer"
                        >
