            ...
            <form wire:submit="login" class="space-y-4">
                ...
                <div class="space-y-1.5" x-data="{ showPassword: false }">
                    ...
                    <div class="relative">
                        ...
                        <button
                            type="button"
                            @click="showPassword = !showPassword; const el = document.getElementById('admin_password'); el.type = showPassword ? 'text' : 'password';"
                            onclick="const el = document.getElementById('admin_password'); const isPass = el.type === 'password'; el.type = isPass ? 'text' : 'password'; document.getElementById('admin-eye-open').classList.toggle('hidden'); document.getElementById('admin-eye-closed').classList.toggle('hidden');"
                        ...
                        >
                            {{-- Eye Open --}}
                            <svg id="admin-eye-open" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                            {{-- Eye Slash --}}
                            <svg id="admin-eye-closed" class="w-4 h-4 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
