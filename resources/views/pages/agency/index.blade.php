...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-2">
                ...
                <span class="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-yellow-500/10 text-yellow-300 border border-yellow-500/20">
                    Agency Suite
                </span>
            </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="/admin/{{ $account?->id ?? 1 }}/agency-branding-settings" class="px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-yellow-500 text-slate-950 font-bold text-xs shadow-md hover:opacity-95 transition-opacity">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div class="glass-card glass-card-hover rounded-3xl p-6 relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold font-heading text-emerald-400 mb-1">{{ $profiles->count() }}</div>
        ...
        <div class="glass-card glass-card-hover rounded-3xl p-6 relative overflow-hidden">
            ...
            <div class="text-3xl font-extrabold font-heading text-yellow-400 mb-1">{{ $members->count() + 1 }}</div>
    ...
    <div class="glass-card rounded-3xl overflow-hidden border border-white/10">
        <div class="px-6 py-5 border-b border-white/5 flex items-center justify-between">
            ...
            <a href="/admin/{{ $account?->id ?? 1 }}/profiles/create" class="text-xs font-semibold px-3 py-1.5 rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 hover:bg-emerald-500/20 transition-all">
                + Provision Client
            </a>
        </div>
