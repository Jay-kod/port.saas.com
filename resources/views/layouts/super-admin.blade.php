...
<body class="bg-black text-slate-100 selection:bg-amber-500 selection:text-black font-sans" x-data="{ sidebarOpen: false, sidebarCollapsed: false, showLogoutModal: false }">
    ...
    <aside id="super-admin-sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-5 font-sans">
            ...
            <div>
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="{{ route('super-admin.dashboard') }}" 
                       ...
                       class="nav-tile-link group {{ request()->routeIs('super-admin.dashboard') ? 'is-active' : '' }}"
                       title="Master Overview">
                        ...
                        <span x-show="!sidebarCollapsed" class="nav-tile-text font-mono font-bold">Platform Telemetry</span>
                    </a>
                </div>
            </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="/admin/{{ $tenantId }}/portfolio-reports" 
                       ...
                       title="Moderation Queue">
                        ...
                        <span x-show="!sidebarCollapsed" class="nav-tile-text">Moderation Queue</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/themes" 
                       ...
                       title="Global Themes">
                        ...
                        <span x-show="!sidebarCollapsed" class="nav-tile-text">Themes Catalog</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/templates" 
                       ...
                       title="Resume Templates">
                        ...
                        <span x-show="!sidebarCollapsed" class="nav-tile-text">Templates Catalog</span>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-3 border-t border-amber-950/70">
                <div class="nav-section-title text-slate-500" x-show="!sidebarCollapsed">
                    Tenant Workspaces
                </div>
                <div class="space-y-1.5">
                    <!-- User Dashboard -->
                    <a href="{{ route('dashboard') }}" 
                       ...
                       title="User Dashboard (New Tab)">
                        ...
                        <span x-show="!sidebarCollapsed" class="nav-tile-text flex items-center justify-between flex-1">
        ...
        <div class="p-3 border-t border-amber-950/70 bg-black">
            <button type="button" 
                    ...
                    :class="sidebarCollapsed ? 'justify-center px-0' : 'px-2.5'" 
                    class="nav-tile-link w-full group hover:bg-amber-950/40 border border-transparent hover:border-amber-900/40 transition-all cursor-pointer" 
                    title="Sign Out">
                <div class="nav-tile-icon group-hover:bg-amber-900/40 group-hover:border-amber-500/50 group-hover:text-amber-200">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                </div>
                <span x-show="!sidebarCollapsed" class="nav-tile-text group-hover:text-amber-200 font-bold font-mono">Terminate Session</span>
            </button>
        </div>
    </aside>
