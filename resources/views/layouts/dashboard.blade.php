        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-4">
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('dashboard') }}" 
                       ...
                       class="sidebar-link flex items-center py-2 rounded-xl text-xs font-medium {{ request()->routeIs('dashboard') ? 'active-nav-pill font-semibold' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white' }} transition-all"
                       title="Dashboard">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap font-semibold">Dashboard</span>
                    </a>

                    <!-- Agency Workspace -->
                    <a href="{{ route('agency') }}" 
                       :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3 px-3'" 
                       class="sidebar-link flex items-center py-2 rounded-xl text-xs font-medium {{ request()->routeIs('agency') ? 'active-nav-pill font-semibold' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white' }} transition-all"
                       title="Agency Hub">
                        <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="pt-2 border-t border-white/5">
                ...
                <div class="space-y-0.5">
                    ...
                    <a href="/admin/{{ $tenantId }}/profiles" 
                       :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3 px-3'" 
                       class="sidebar-link flex items-center py-2 rounded-xl text-xs font-medium text-slate-300 hover:bg-slate-800/50 hover:text-white transition-all"
            ...
            <div class="pt-2 border-t border-rose-500/20">
                ...
                <a href="{{ route('super-admin.dashboard') }}" 
                    :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3 px-3'" 
                    class="sidebar-link flex items-center py-2 rounded-xl text-xs font-medium bg-rose-500/10 text-rose-300 border border-rose-500/30 hover:bg-rose-500/20 transition-all font-mono"
