...
<body class="bg-slate-950 {{ $selectionBg }}" x-data="{ sidebarOpen: false, sidebarCollapsed: false, showLogoutModal: false }">
    ...
    <aside id="dashboard-sidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-5 px-3.5 space-y-6">
            ...
            <div>
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="{{ route('dashboard') }}" 
                       ...
                       class="sidebar-link group flex items-center py-2.5 rounded-xl text-xs font-semibold {{ request()->routeIs('dashboard') ? 'active-nav-pill' : 'text-slate-300 hover:bg-slate-900/90 hover:text-white border border-transparent hover:border-white/5' }} transition-all"
                       title="Dashboard">
                        <div class="w-8 h-8 shrink-0 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-400/30' : 'bg-slate-900/90 text-slate-400 border border-white/5 group-hover:text-emerald-400 group-hover:bg-emerald-500/10 group-hover:border-emerald-500/20' }} flex items-center justify-center transition-all">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap font-bold">Dashboard</span>
                    </a>

                    <!-- Agency Workspace -->
                    <a href="{{ route('agency') }}" 
                       :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3.5 px-3'" 
                       class="sidebar-link group flex items-center py-2.5 rounded-xl text-xs font-semibold {{ request()->routeIs('agency') ? 'active-nav-pill' : 'text-slate-300 hover:bg-slate-900/90 hover:text-white border border-transparent hover:border-white/5' }} transition-all"
                       title="Agency Hub">
                        <div class="w-8 h-8 shrink-0 rounded-lg {{ request()->routeIs('agency') ? 'bg-teal-500/20 text-teal-300 border border-teal-400/30' : 'bg-slate-900/90 text-slate-400 border border-white/5 group-hover:text-teal-400 group-hover:bg-teal-500/10 group-hover:border-teal-500/20' }} flex items-center justify-center transition-all">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                        </div>
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Agency Hub</span>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-3 border-t border-white/5">
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="/admin/{{ $tenantId }}/profiles" 
                       :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3.5 px-3'" 
                       class="sidebar-link group flex items-center py-2.5 rounded-xl text-xs font-semibold text-slate-300 hover:bg-slate-900/90 hover:text-white border border-transparent hover:border-white/5 transition-all"
                       title="Profile Details">
                        <div class="w-8 h-8 shrink-0 rounded-lg bg-slate-900/90 text-slate-400 border border-white/5 group-hover:text-emerald-400 group-hover:bg-emerald-500/10 group-hover:border-emerald-500/20 flex items-center justify-center transition-all">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                        </div>
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Profile & Bio</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/projects" 
                       ...
                       title="Projects Showcase">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Projects</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/experiences" 
                       ...
                       title="Career Experience">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Experience</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/skills" 
                       ...
                       title="Technical Skills">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Skills Matrix</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/certificates" 
                       ...
                       title="Accreditations">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Certificates</span>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-3 border-t border-white/5">
                <div class="sidebar-label px-2 mb-2" x-show="!sidebarCollapsed">
                    <span class="text-[10px] uppercase font-bold tracking-wider text-slate-500 font-mono">Career & AI Suite</span>
                </div>
                <div class="space-y-1.5">
                    <!-- AI Resumes -->
                    <a href="/admin/{{ $tenantId }}/resume-generations" 
                       ...
                       title="Tailored Resumes">
                        <div class="w-8 h-8 shrink-0 rounded-lg bg-slate-900/90 text-slate-400 border border-white/5 group-hover:text-yellow-400 group-hover:bg-yellow-500/10 group-hover:border-yellow-500/20 flex items-center justify-center transition-all">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        </div>
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">AI Resumes</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/cover-letter-generations" 
                       ...
                       title="Cover Letters">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Cover Letters</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/job-tracker" 
                       ...
                       title="Job Application Pipeline">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Job Tracker (Kanban)</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/resume-import" 
                       ...
                       title="PDF Parser & Importer">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Import Resume PDF</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/github-settings" 
                       ...
                       title="GitHub Repositories">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">GitHub Sync</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/ai-settings" 
                       ...
                       title="OpenAI / Anthropic Keys">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">AI Settings (BYOK)</span>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-3 border-t border-white/5">
                <div class="sidebar-label px-2 mb-2" x-show="!sidebarCollapsed">
                    <span class="text-[10px] uppercase font-bold tracking-wider text-slate-500 font-mono">Platform Design</span>
                </div>
                <div class="space-y-1.5">
                    <!-- Themes & Palettes -->
                    <a href="/admin/{{ $tenantId }}/theme-selector" 
                       ...
                       title="Visual Themes & Modes">
                        <div class="w-8 h-8 shrink-0 rounded-lg bg-slate-900/90 text-slate-400 border border-white/5 group-hover:text-cyan-400 group-hover:bg-cyan-500/10 group-hover:border-cyan-500/20 flex items-center justify-center transition-all">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Theme & Mode</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/domain-settings" 
                       ...
                       title="Custom Apex & CNAME Domains">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Custom Domains</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/templates" 
                       ...
                       title="Resume Templates Catalog">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Resume Templates</span>
                    </a>
                </div>
            </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="/admin/{{ $tenantId }}/billing-settings" 
                       ...
                       title="Subscription & Invoices">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Billing & Usage</span>
                    </a>
                    ...
                    <a href="/admin/{{ $tenantId }}/privacy-and-data" 
                       ...
                       title="Privacy & Data Export">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Privacy & GDPR</span>
                    </a>
                    ...
                    <a href="{{ route('onboarding') }}" 
                       ...
                       title="Setup Wizard">
                        ...
                        <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap">Setup Wizard</span>
                    </a>
                </div>
            </div>
            ...
            <div class="pt-3 border-t border-rose-500/20">
                ...
                <a href="{{ route('super-admin.dashboard') }}" 
                    :class="sidebarCollapsed ? 'justify-center px-0' : 'gap-3.5 px-3'" 
                    class="sidebar-link group flex items-center py-2.5 rounded-xl text-xs font-semibold bg-rose-500/10 text-rose-300 border border-rose-500/30 hover:bg-rose-500/20 transition-all font-mono"
                    title="Super Admin Master Control">
                    <div class="w-8 h-8 shrink-0 rounded-lg bg-rose-500/20 text-rose-300 border border-rose-500/30 flex items-center justify-center transition-all">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                    </div>
                    <span x-show="!sidebarCollapsed" class="sidebar-label whitespace-nowrap font-bold">SUPER ADMIN</span>
                </a>
            </div>
            @endif
        </nav>
